...
<?php
  ...
  {
    $errorNo++;
    $errorMessage=$errorMessage."<strong class='text-success'>($errorNo)</strong> You have <strong class=text-danger> ".$notReplied. "</strong> letter(s) which you haven't sent a reply yet.Please,click the <a href='tables.php' class='btn btn-danger text-center' style='font-size:13px;'>Sent Reply</a> button after sending replies.<br><br> ";
  }
  ...
  {
    $errorNo++;
    $errorMessage=$errorMessage."<div class='text-danger'><strong class='text-success'>($errorNo)</strong> You have <strong class=text-primary> ".$reachingDeadline. "</strong> letter(s) appraoching deadline in <strong class=text-primary>Two or less</strong> days.Please give a reply to the letter as soon as possible. Please,click the <a href='tables.php' class='btn btn-danger text-center' style='font-size:13px;'>Sent Reply</a> button if you have sent replies already.<br><br></div> ";
  }
  ...
  $tempQuery1111="
    ...
    {
      $errorNo++;
      $errorMessage=$errorMessage."<div class='text-danger'><strong class='text-success'>($errorNo)</strong><strong> You have <strong class=text-primary> ".$reachedDeadline. "</strong> letter(s) which have passsed Deadlies. Check <a href='tables.php'>Letters</a> and contact Registrar Building.<br></strong> ";
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Recieved Letters (last 7 days)</div>
            ...
            <div class="col-xl-6 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Replies Sent(last 7 days)</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="mt-4 text-center small" style="font-size: 10px;">
                    <span class="mr-2">
                      <i class="fas fa-circle text-primary"></i> Recieved Letter(s)
                    </span>
                    <span class="mr-2">
                      <i class="fas fa-circle text-success"></i> Repliable Letter(s)
                    </span>
                    <span class="mr-2">
                      <i class="fas fa-circle text-info"></i> Replie(s) Sent
                    </span>
                    <span class="mr-2">
...
var myPieChart = new Chart(ctx, {
  type: 'doughnut',
  data: {
    labels: ["Recieved Letters", "Repliable Letters", "Replies Sent","Deadlines Reached"],
    datasets: [{
