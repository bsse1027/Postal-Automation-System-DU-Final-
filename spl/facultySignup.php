...
<?php
    ...
    if(isset($_POST['create']))
    {
...

        {
            ...
            INSERT INTO `signed_teacher` (`teacher_id`,`nameEng`, `nameBang`, `dept`,`designation`, `email`, `phone`, `password`) VALUES ('$id','$firstname', '$lastname', '$dept','$designation', '$email', '$phone', '$password')
            LIMIT 1
            ...
            <form action="#" method="POST">
                <div class="row">
                    ...
                    <div class="input-group col-lg-12 mb-4">
                        ...
                        <input required id="phoneNumber" type="tel" name="phone" placeholder="Phone Number" class="form-control bg-white border-md border-left-0 pl-3">
                    </div>
