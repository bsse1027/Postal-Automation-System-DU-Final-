...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <?php include BASE_URL."staffLogin/include/sidebar.php"; ?> 
    <!-- End of Sidebar -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <?php include BASE_URL."staffLogin/include/header.php"; ?> 
        <!-- End of Topbar -->
      ...
      <!-- Footer -->
      <?php include BASE_URL."staffLogin/include/footer.php"; ?> 
      <!-- End of Footer -->
  ...
  <?php include BASE_URL."staffLogin/include/script.php"; ?> 
