...
function send_msg($mobile_no){
    ...
    $msg ="Dear Sir/Madam, please check the Email and I request you to take the next necessary action.";
...
{ 
    ...
    $tempQuery= "INSERT INTO `emails`(`ref_number`, `recipient`, `send_date`, `subject`, `body`, `deadline`, `reply`,`email`) VALUES ('$memo','$teacher_name_1','$date','$type','$path1','$deadline','0','$teacher_email_1')";
	 ...
	 $tempQuery= "INSERT INTO `emails`(`ref_number`, `recipient`, `send_date`, `subject`, `body`, `deadline`, `reply`,`email`) VALUES ('$memo','$teacher_name_2','$date','$type','$path2','$deadline','0','$teacher_email_2')";
	 ...
	 $tempQuery= "INSERT INTO `emails`(`ref_number`, `recipient`, `send_date`, `subject`, `body`, `deadline`, `reply`,`email`) VALUES ('$memo','$teacher_name_3','$date','$type','$path3','$deadline','0','$teacher_email_3')";
	 ...
	 $tempQuery= "INSERT INTO `emails`(`ref_number`, `recipient`, `send_date`, `subject`, `body`, `deadline`, `reply`,`email`) VALUES ('$memo','$teacher_name_4','$date','$type','$path4','$deadline','0','$teacher_email_4')";
	 ...
	 $tempQuery= "INSERT INTO `emails`(`ref_number`, `recipient`, `send_date`, `subject`, `body`, `deadline`, `reply`,`email`) VALUES ('$memo','$dept_teacher_name','$date','$type','$path5','$deadline','0','$dept_email')";
