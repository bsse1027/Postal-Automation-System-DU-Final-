...
<html lang="en">
   <head>
    ...
    <!-- Required meta tags -->
        ...
        <link rel="stylesheet" href="<?php echo SERVER_URL?>resources/css/t5.css">
    ...
    ?>
        ...
        <div class="row">
                    <div class="column address">
                        ...
                        <p>Email:co_letter@du.ac.bd</p>

                    </div>

                    <div class="column image">
                      <img src="<?php echo SERVER_URL?>resources/img/DhakaUniversity.jpg" width="70" height="90">
