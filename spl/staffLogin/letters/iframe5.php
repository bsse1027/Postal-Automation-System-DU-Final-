...
show pdf
<iframe src=<?php echo $path?> height=200 width=100% title="Iframe Example"></iframe>
...
/* Set the mail sender. */
$mail->setFrom('db28111997@gmail.com','Exam Control Office, DU');
    ...
    $sql1 = "INSERT INTO  memo (memo_no,letter_id)
     ...
     if(mysqli_query($link,$sql1))
     {
        echo "New record created successfully<br>";
                                    ...
                                    VALUES ('$a','$new','$c','$d1','$dept','$year','$xm','$yr','$r1','$r2','$cr','$deadline','$type')";
                                 ...
                                 $tempQuery= "INSERT INTO `emails`(`ref_number`, `recipient`, `send_date`, `subject`, `body`, `deadline`, `reply`,`email`) VALUES ('$a','$c','$date','$type','http://BASE_URL/spl/Files/$a.pdf','$deadline','0','$email')";
